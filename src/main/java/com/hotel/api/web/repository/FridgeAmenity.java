...
public class FridgeAmenity extends AmenityDecorator {

	public FridgeAmenity(AmenityDecorator nextDecorator) {
		super(nextDecorator);
	}
	...
	public void addAmenities(Long roomId, JdbcTemplate jdbcTemplate) {
		...
		jdbcTemplate.update(insertAmenitySql, roomId, "fridge");
	}
}
